...
export default class RightPanelScript extends FIRENEF.Script {
    constructor(name = "Right Panel Script") {
        super(name);
    ...
    resize(e) {
        this.backgroundElement.style.width = `${window.innerWidth - e.clientX}px`;
    }
}