...
// WebGPU replacement
export * from './csm/CSMShadowNode.js';
...
// WebGPU replacement
export * from './tsl/display/AnaglyphPassNode.js';
// Outline effect replaced by built in ToonOutlinePassNode
export * from './tsl/display/ParallaxBarrierPassNode.js';
export * from './tsl/display/StereoPassNode.js';
...
export * from './misc/ProgressiveLightMapGPU.js';
...
// WebGPU replacement
export * from './objects/LensflareMesh.js';
// Reflector replaced by built in ReflectorNode
// Refractor replaced by built in ViewportSharedTextureNode
...
export * from './utils/ShadowMapViewerGPU.js';
export * as SkeletonUtils from './utils/SkeletonUtils.js';
export * as SortUtils from './utils/SortUtils.js';
export * from './utils/WebGPUTextureUtils.js';
export * from './utils/UVsDebug.js';
export * from './utils/WorkerPool.js';

/* Unsupported on WebGPU. will try to fix later
