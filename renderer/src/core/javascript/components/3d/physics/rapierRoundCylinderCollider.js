...
export class RapierRoundCylinderCollider extends RapierCollider {
    constructor(name = "Rapier Round Cylinder Collider") {
        super(name);
    ...
    static type = "rapierRoundCylinderCollider";
    ...
    updateShape() {
        ...
        this.desc = RAPIER.ColliderDesc.roundCylinder(hh, r, rr);
    }
